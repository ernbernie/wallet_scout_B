...
fn test_analysis_pipeline_distribution_wallet() {
    ...
    assert!(insights
        .patterns
        .iter()
        .any(|p| p.name == "Distribution Wallet"));
    ...
    assert!(insights
        .recommendations
        .iter()
        .any(|r| r.contains("distribution wallet")));
}
...
fn test_analysis_pipeline_high_value_wallet() {
    ...
    assert!(insights
        .patterns
        .iter()
        .any(|p| p.name == "High Value Wallet"));
...
fn test_analysis_pipeline_suspicious_wallet() {
    ...
    assert!(insights
        .patterns
        .iter()
        .any(|p| p.name == "Suspicious Activity"));
